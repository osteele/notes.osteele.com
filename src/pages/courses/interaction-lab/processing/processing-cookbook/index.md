...
![Language Mode: Text. Color Theme: Light.](/images/processing-cookbook/Untitled 5.png)

Language Mode: Text. Color Theme: Light.

![Language Mode: Java. Color Theme: Light.](/images/processing-cookbook/Untitled 6.png)
...
![](/images/processing-cookbook/Untitled 7.png)
...
![](/images/processing-cookbook/Untitled 8.png)
...
![](/images/processing-cookbook/Untitled 9.png)
...
- Install the [Language Support for Java](https://marketplace.visualstudio.com/items?itemName=redhat.java) extension. See the instructions in the “Teaching VS Code to Recognize *.pde Files as Java” for how to install an extension.
    ...
    ![](/images/processing-cookbook/Untitled 10.png)
...
- Download and install the Java development Kit from [https://adoptopenjdk.net](https://adoptopenjdk.net/). You can leave the default Version and JVM selected, and simply click on Latest release.
    ...
    ![VS Code will prompt to install the JDK, once the Language Support extension is installed.](/images/processing-cookbook/Untitled 11.png)
...
![The web site. Click on Latest release.](/images/processing-cookbook/Untitled 12.png)
