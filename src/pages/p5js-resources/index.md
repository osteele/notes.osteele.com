...
Resources for learning [p5.js](https://p5js.org) and JavaScript.

# Look Here First

Familiarize yourself with the [p5.js site](https://p5js.org) for official documentation, examples, and tutorials.
...
- [p5.js Books](https://p5js.org/books/)
- [The Coding Train](https://thecodingtrain.com/Tutorials/) is a set of videos that introduce JavaScript and p5.js.
- [OpenProcessing.org](http://openprocessing.org) has [tutorials](https://www.openprocessing.org/learn/), and [curated collections](https://www.openprocessing.org/user/1#curations) that include additional tutorials, advanced topics.

Also see my [JavaScript Resources](/javascript/) notes, for a list of resources that teach pure JavaScript without reference to p5.js.

# Creating and Editing p5.js Sketches

You can edit and run your p5.js code in an online editor (such as the [P5 Web Editor](https://editor.p5js.org/), [OpenProcessing.org](/p5js-resources/), or [Glitch](/p5js-resources/)) that runs in your web browser; or, in an application that you runs on your computer (such as Visual Studio Code or Atom).
...
- If you use the Duck Duck Go search engine, search for e.g. “!p5 rect” to go straight to the documentation for the `rect()` function.

Also see the Reference section of my [JavaScript Resources](/javascript/) notes.

Also see [p5.js Course Materials](/p5js-resources/) for libraries, examples, and tutorials that I've developed for my courses.
