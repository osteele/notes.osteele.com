---
title: "Movement Practices Coding Resources"
...
- [Annotated p5.js + PoseNet project](https://github.com/osteele/p5pose/blob/master/src/sketch.js). (Note that this uses the `p5.` prefix before p5 functions. Your code doesn't need this.)
