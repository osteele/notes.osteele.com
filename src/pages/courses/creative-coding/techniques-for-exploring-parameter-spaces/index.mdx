...
<CodeExample live canvasHeight={400} code={`function setup() {
...
}`} lang="jsx" image="/images/techniques-for-exploring-parameter-spaces/techniques-for-exploring-parameter-spaces-06.png" alt="" />

# 1. Editing Code

Let's edit the code to use a different value for `ratio`:

<CodeExample live canvasHeight={400} preamble={`function setup() { createCanvas(windowWidth, windowHeight); angleMode(DEGREES); }`} code={`function draw() {
	background(10);
	translate(width / 2, height / 2);
	noStroke();
...
}`} lang="jsx" image="/images/techniques-for-exploring-parameter-spaces/techniques-for-exploring-parameter-spaces-04.png" alt="" />
...
}`} lang="jsx" image="/images/techniques-for-exploring-parameter-spaces/techniques-for-exploring-parameter-spaces-05.png" alt="" />
...
<CodeExample live animated canvasHeight={400} preamble={`function setup() { createCanvas(windowWidth, windowHeight); angleMode(DEGREES); }`} code={`function draw() {
	background(10);
	translate(width / 2, height / 2);
	noStroke();
...
}`} lang="jsx" image="/images/techniques-for-exploring-parameter-spaces/techniques-for-exploring-parameter-spaces-01.gif" alt="" />
...
}`} lang="jsx" image="/images/techniques-for-exploring-parameter-spaces/techniques-for-exploring-parameter-spaces-02.gif" alt="" />
...
<CodeExample live animated canvasHeight={400} preamble={`function setup() { createCanvas(windowWidth, windowHeight); angleMode(DEGREES); }`} code={`let ratio;
...
}`} lang="jsx" image="/images/techniques-for-exploring-parameter-spaces/techniques-for-exploring-parameter-spaces-03.gif" alt="" />
