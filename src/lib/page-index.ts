...
export const mlSections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/ml/subspace-geometry/", title: "Subspace Geometry", desc: "PCA projection, principal angles, Procrustes and affine alignment, and relative representations by anchors" },
      ...
      { href: "/ml/interchange-interventions/", title: "Interchange Interventions & DAS", desc: "Trained low-rank activation swaps, matched random controls, transfer normalization, and expressive-fit cautions" },
    ],
  },
  {
    ...
    items: [
      ...
      { href: "/ml/c-command-binding/", title: "C-Command & Binding Domains", desc: "Principles A/B/C, c-command domains, dependency-depth proxies, and island boundaries as interactive tree geometry" },
      ...
      { href: "/ml/mental-spaces/", title: "Mental Spaces", desc: "Fauconnier-style reality, belief, and picture frames with connectors and frame-specific readouts" },
      { href: "/ml/false-belief-tasks/", title: "False-Belief Tasks", desc: "Sally-Anne, unexpected contents, and shortcut-blocking controls for belief-versus-reality stimuli" },
