...
1. Use a *single loop* to iterate over the number of items; derive the x and y position from the item number.
    ...
    ![Screenshot of Notion (4-8-22, 12-57-55 AM).png](/images/arranging-items-in-a-grid/Screenshot_of_Notion_%284-8-22_12-57-55_AM%29.png)
...
2. Use a *nested loop* to iterate over the x positions and, for each x, iterate over the y positions (left sketches). If the item number is required, derive it from the values of x and y (right sketch).
    ...
    ![Screenshot of Microsoft Edge (4-8-22, 1-02-54 AM).png](/images/arranging-items-in-a-grid/Screenshot_of_Microsoft_Edge_%284-8-22_1-02-54_AM%29.png)
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 1.png" alt="" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 3.png" alt="" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled.png" alt="" />
...
![Screenshot of Safari (4-8-22, 12-44-58 AM).png](/images/arranging-items-in-a-grid/Screenshot_of_Safari_%284-8-22_12-44-58_AM%29.png)
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Screenshot_of_Notion_%284-8-22_12-48-49_AM%29.png" alt="Screenshot of Notion (4-8-22, 12-48-49 AM).png" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Screenshot_of_Safari_%284-8-22_12-52-02_AM%29.png" alt="Screenshot of Safari (4-8-22, 12-52-02 AM).png" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 2.png" alt="" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 4.png" alt="" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Screenshot_of_Safari_%284-8-22_1-04-36_AM%29.png" alt="Screenshot of Safari (4-8-22, 1-04-36 AM).png" />
...
function decoratedSquare(x, y, row, column, i) {
	...
	pop();
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Screenshot_of_Safari_%284-8-22_1-06-49_AM%29.png" alt="Screenshot of Safari (4-8-22, 1-06-49 AM).png" />
...
function circles(x, y) {
	...
	pop();
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 5.png" alt="" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Screenshot_of_Notion_%284-8-22_1-09-40_AM%29.png" alt="Screenshot of Notion (4-8-22, 1-09-40 AM).png" />
...
<CodeExample code={`function circles(x, y) {
	...
	pop();
}`} lang="jsx" image="/images/arranging-items-in-a-grid/CleanShot_2022-04-08_at_01.11.25.gif" alt="CleanShot 2022-04-08 at 01.11.25.gif" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 6.png" alt="" />
...
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 7.png" alt="" />
...
function myShape(x, y, row, column, i) {
	...
	circle(0, size, size / 2);
	circle(size, size, size / 2);
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 8.png" alt="" />
...
function myShape(x, y, row, column, i) {
	...
	circle(0, size, size / 2);
	circle(size, size, size / 2);
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 9.png" alt="" />
...
function myShape(x, y, row, column, i) {
	...
	circle(0, size, size / 2);
	circle(size, size, size / 2);
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 10.png" alt="" />
...
function myShape(x, y, row, column, i) {
	...
	circle(size, size, size / 2);
	pop();
}`} lang="jsx" image="/images/arranging-items-in-a-grid/Untitled 11.png" alt="" />
