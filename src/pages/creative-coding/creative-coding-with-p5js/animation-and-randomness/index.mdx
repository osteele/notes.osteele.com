...
- ***Time***. In p5.js, the `frameCount` function and the `millis()` variable are the sources of time. We explored that in [Time-Based Animation](/creative-coding/creative-coding-with-p5js/animation-and-randomness/).
